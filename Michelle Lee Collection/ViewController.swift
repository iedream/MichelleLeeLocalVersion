...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    let mainTitleViewControllerData = ["mainToAbulm","mainToVideo","mainToVideo","mainToVideo","mainToVideo"]
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "mainToVideo"){
            ...
            if(currentName != "快乐女声" && currentName != "晚会"){
                destView.mainDicMulti = allVideoPlayist[currentName]! as! [String : [String : String]]
                destView.imageName = backGroundImageList[currentName]!
                destView.getImage()
                
            }else{
                destView.mainDicSingle = allVideoPlayist[currentName]! as! [String : String]
                destView.imageName = backGroundImageList[currentName]!
                destView.getImage()
            }
